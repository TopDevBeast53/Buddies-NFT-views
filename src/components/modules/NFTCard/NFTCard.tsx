...
const NFTCard: FC<NFTCardParams> = ({ nft: { amount, contractType, name, symbol, tokenUri } }) => {
  ...
  return (
    <Box maxWidth="315px" bgColor={bgColor} padding={3} borderRadius="xl" borderWidth="1px" borderColor={borderColor}>
      <Box maxHeight="260px" overflow={'hidden'} borderRadius="xl">
        <Image src={resolveIPFS(tokenUri)} alt={'nft'} minH="260px" minW="260px" boxSize="100%" objectFit="fill" />
      </Box>
